    ...
    <section id="about" className="py-24 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="flex justify-start mb-8">
          <a
            href="#hero"
            className="flex items-center px-6 py-3 text-lg font-medium text-white bg-gray-800 hover:bg-gray-700 rounded-xl border border-gray-700 shadow-lg transition-all duration-300"
          >
